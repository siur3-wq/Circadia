export const BANNERS = [
  ...
  { id: "banner_champion", name: "Champion",      gradient: "from-yellow-500 via-amber-500 to-orange-500", emoji: "👑", unlockXP: 5000, pattern: "crown" }
];

export function getUnlockedBanners(totalXP) {
  return BANNERS.filter(b => totalXP >= b.unlockXP);
}